...
- [x] August: Rusty Boat course
- [x] September: secret (shh)
- [ ] October: rewrite mosaic program to create gifts
- [ ] November: explore digital privacy/control options (VPN, browsers, email, GitHub alternatives, colocated hosting for anything I decide to host?)
- [ ] December: _Star Wars: Imperial Assault_ painted. Minimum 1 squad completed/mo.
    ...
    - [x] September: Gamorrean Guards (I actually painted this month! They aren't done though)
    - [ ] October: ???
    - [x] November: Gamorrean Guards (finished the elites)
    - [ ] December: ???
